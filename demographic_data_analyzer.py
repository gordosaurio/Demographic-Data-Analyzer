...
def calculate_demographic_data(print_data=True):
    ...
    country_percent = df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts() * 100
    highest_earning_country = country_percent.idxmax()
    highest_earning_country_percentage = round(country_percent.max(), 1)

    # 8. Most popular occupation in India for those earning >50K
